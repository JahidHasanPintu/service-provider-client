...
const Contact = () => {
    ...
    return (
        <div>
            <Breadcumbs name={"Contact"} path={"/contact"} />
            <div className="contact-wrapper w-11/12 mx-auto mb-10">
                <div className="container-x mx-auto">
                    <div className="main-wrapper w-full lg:flex lg:space-x-[30px]">
                        <div className="lg:w-1/2 w-full">
                            <h1 className="text-[22px] text-start font-semibold text-qblack leading-[30px] mb-1">Contact Information</h1>
                            <p className="text-[15px] text-start text-qgraytwo leading-[30px] mb-5">Fill the form below or write us .We will help you as soon as possible.</p>
                        ...
                        <div className="flex-1 text-start bg-white sm:p-10 p-3">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="inputs mt-5">
                                    ...
                                    <div className="mb-4">
                                        <div className="input-com w-full h-full"><label className="input-label capitalize block  mb-2 text-qgray text-[13px] font-normal" htmlFor="email">Email Address*</label>
                                            <div className="input-wrapper border border-qgray-border w-full h-full overflow-hidden relative "><input
                                                ...
                                                required
                                                className="input-field placeholder:text-sm text-sm px-6 text-dark-gray w-full font-normal bg-white focus:ring-0 focus:outline-none h-[50px]" id="email" defaultValue="" /></div>
                                        </div>
                                    </div>
                                    <div className="mb-4">
                                    ...
                                    <div className="mb-5">
                                        <h6 className="input-label text-qgray capitalize text-[13px] font-normal block mb-2 ">Message*</h6><textarea
                                            name="message"
