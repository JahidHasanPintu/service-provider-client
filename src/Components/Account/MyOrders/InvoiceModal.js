...
//     const formattedDate = new Date(orderCreatedAt).toLocaleString(
//       "en-US",
//       options
//     );
...
//             <a href="#" class="noble-ui-logo block mt-3">
//               Dutta<span>Hardware</span>
//             </a>
//             <p class="mt-1 mb-1">
//               <b>Hardware Marketplace</b>
//             </p>
//             <p>
//               108,
//               <br />
//               Dutta Street,
//               <br />
//               Rajbari, Dhaka Division BD.
//             </p>
//             <h5 class="mt-5 mb-2 text-muted">Invoice to :</h5>
//             <p>
//               {orderDetails?.user_info.fullname}
//               <br />
//               {orderDetails?.user_info.phone},<br />
...
//             <h4 class="text-end font-normal">
//               ৳ {orderDetails?.payment_details.total}
//             </h4>
//             <p class="text-end mb-1">Status</p>
//             <h4 class="text-end font-normal">
//               {orderDetails?.payment_details.payment_status}
//             </h4>
//             <h6 class="mb-0 mt-3 text-end font-normal mb-2">
//               <span class="text-muted"> Date :</span> {OrderCreationTime()}
//             </h6>
//           </div>
//         </div>
...
//                       <td class="text-end">
//                         ৳ {orderDetails?.payment_details.subtotal}
//                       </td>
//                     </tr>
//                     <tr>
//                       <td class="text-start">Shipping</td>
//                       <td class="text-end">
//                         ৳ {orderDetails?.payment_details.shipping}{" "}
//                       </td>
//                     </tr>
//                     <tr>
//                       <td class="text-start">Discount</td>
//                       <td class="text-danger text-end">
//                         (-) ৳ {orderDetails?.payment_details.discount}
//                       </td>
//                     </tr>
